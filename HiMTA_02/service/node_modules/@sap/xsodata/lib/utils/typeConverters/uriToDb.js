...
uriToDb['Edm.Time'] = function uriToDbEdmTime(value, dbDataType) {
    /* in      "time'PT0H0M0S'"                                 */
    /* out    "00:00:00"                        */
    /* in      "time'PT23H59M59S'"                                 */
    /* out    "23:59:59"                        */
    ...
    var matches = timeRegexObj.exec(value);
    var timeParts = matches.slice(1);
    if (timeParts[3]) {
        throw new NotSupported('Fractional part for OData type Edm.Time not supported');
    }

    timeParts[0] = (timeParts[0]) ? padZero(timeParts[0], 2) : '00';
    timeParts[1] = (timeParts[1]) ? padZero(timeParts[1], 2) : '00';
    timeParts[2] = (timeParts[2]) ? padZero(timeParts[2], 2) : '00';
