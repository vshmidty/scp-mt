...
var BadRequest = require('./errors/http/badRequest');
...
exports.validateAndSetLinksPayload = function (linksPayload, dbSeg, baseUrl) {
    var refEntity = dbSeg.entityType.name;
    ...
    var segment = linksPayload.uri.substring(lastSegIndexBegin + 1, linksPayload.uri.length),
        parsed;
    ...
    dbSeg.setKeyValues(parsed.keys);
};
