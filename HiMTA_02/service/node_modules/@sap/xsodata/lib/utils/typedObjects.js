 ...
 */
DateTime.prototype.toSqlHana = function (context, parameter) {
...
BinaryOperator.prototype.toSqlHana = function toSqlHana(context, parameter) {
    ...
    let left = this.left.toSqlHana(context, pLeft);
    let right = this.right.toSqlHana(context, pRight);
 ...
 * Tested via test_filter_parser.js
 */
function Property(property, table) {
