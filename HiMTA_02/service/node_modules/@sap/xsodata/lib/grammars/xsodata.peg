...
entity                   = o:object es:(MWS entityset )? w:(MWS with)? k:(MWS keys)? ct:(MWS concurrencytoken)? rt:(MWS retain_order)? n:(MWS navigates)? ge:(MWS globalExpand)? a:(MWS aggregates )? p:(MWS parameters)? m:(modifications)? scopes:(MWS scopes)? ad:(MWS settings_admindata)?
                           {
                                var ret =  {};
...
settingsconfig           = s:(settings_meta_cache / settings_content / settings_enable / settings_support / settings_hints / settings_admindata)
                            { return s; }
