...
function masterTableCreate(sqlContext, rId) {
    ...
    context.logger.debug('createPostStatements', 'masterTableCreate');
...
function masterTableInsertTmp(sqlContext, rId) {
    ...
    context.logger.debug('createPostStatements', 'masterTableInsertTmp');
...
function masterTableInsert(sqlContext, rId) {
    sqlContext.context.logger.debug('createPostStatements', 'createPostSQL_Insert_TmpMasterTable');
    const dbSeg = sqlContext.dbSegLast;
...
function masterTableSelect(sqlContext, rId) {
    sqlContext.context.logger.debug('createPostStatements', 'masterTableSelect');
    const dbSeg = sqlContext.dbSegLast;
