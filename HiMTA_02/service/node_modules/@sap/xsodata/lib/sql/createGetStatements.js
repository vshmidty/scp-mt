...
function masterTable(sqlContext) {
    ...
    if (dbSeg.restriction.onlyCount === true) {
        ...
        if (sqlContext.context.db && sqlContext.context.db.isExternalHandledConnection === true) {
            ...
            truncateStmt = sql.buildTableStatement(sql.Truncate, sqlContext, dbSeg.sql.stmContainer.createTmp.table);
            ...
            dropStmt = sql.buildTableStatement(sql.Drop, sqlContext, dbSeg.sql.stmContainer.createTmp.table);
