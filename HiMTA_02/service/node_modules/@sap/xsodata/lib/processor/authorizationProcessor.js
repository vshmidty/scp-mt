...
exports.processAuthorization = function (context, asyncDone) {
    ...
    var strategies,
        ...
        hasScopes,
        token,
        contextUriType = context.uriTree.uriType,
        innerContext = {
    ...
    async.waterfall(
        ...
        function (err, innerContext) {
            ...
            if (innerContext.isAuthorized !== true) {
                context.isAuthorized = false;
                return asyncDone(new ForbiddenError('Forbidden request', context), context);
            }
 ...
 * @returns {Function} Task to run in the async waterfall of the authorization processor.
 */
exports.buildSecurityContextStrategy =
    function buildSecurityContextStrategy(token, context) {
        ...
        return function (innerContext, done) {
            ...
            securityContext.checkScopes(token, scopes, function (err, isAuthorized) {
