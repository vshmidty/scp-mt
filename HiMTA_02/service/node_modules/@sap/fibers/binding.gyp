{
	'target_defaults': {
		...
		'configurations': {
			'Release': {
				'cflags': [ '-O3', '-fstack-protector --param=ssp-buffer-size=8', '-D_FORTIFY_SOURCE=1', '-fPIC' ],
				'ldflags': ['-z noexecstack', '-fstack-protector --param=ssp-buffer-size=8', '-Wl,-z,relro,-z,now' ],
				'xcode_settings': {
