	...
	private:
		...
		static void RunFiber(void** data) {
			...
			// this function won't be called.
			{
				...
				// SAP d051827 2016-05-24. Increased the padding from 6k to 32k as it was in v1.0.5 to pass all stackoverflow tests
				uni::SetStackGuard(that.isolate, reinterpret_cast<char*>(that.this_fiber->bottom()) + 1024 * 32);
