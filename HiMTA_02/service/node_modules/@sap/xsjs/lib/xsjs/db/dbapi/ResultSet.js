...
ResultSet.prototype.getInteger = function (columnIndex) {
  ...
  return conversions.getInteger(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getBigInt = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getBigInt(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getDecimal = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getDecimal(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getBlob = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getBlob(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getClob = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getClob(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getString = function (columnIndex) {
  ...
  return conversions.getString(value, this._metaData.getColumnType(columnIndex));
};
...
ResultSet.prototype.getDate = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getDate(this._row[this._columnNames[columnIndex - 1]]);
};
...
ResultSet.prototype.getTime = function (columnIndex) {
  argumentsUtil.validateGetterArgs(arguments, 1, this._row);
  return conversions.getTime(this._row[this._columnNames[columnIndex - 1]]);
};
